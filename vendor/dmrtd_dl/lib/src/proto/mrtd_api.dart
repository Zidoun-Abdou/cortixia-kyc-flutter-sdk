...
class MrtdApi {
  ...
  /// Selects ISO/IEC 18013-3 IDL (electronic Driving Licence) applet.
  /// Can throw [ICCError] if command is sent to invalid IDL document.
  /// Can throw [ComProviderError] in case connection is lost.
  Future<void> selectDLApplication() async {
    _log.debug("Selecting ISO 18013-3 IDL application");
    await icc.selectFileByDFName(dfName: DL.AID, p2: _defaultSelectP2);
  }
